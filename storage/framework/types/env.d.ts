...
declare module 'bun' {
  namespace env {
    ...
    const REGIONAL_INGEST_TOKEN: string
    ...
    const WORKER_HEARTBEAT_URL: string
    const WORKER_REGION: string
  }
}
...
declare module '@stacksjs/env' {
  interface StacksEnv {
    ...
    MONITOR_REGIONS: string | undefined
    REGIONAL_INGEST_TOKEN: string | undefined
    SUDO_PASSWORD: string | undefined
    TS_CLOUD_UI_PASSWORD: string | undefined
    WORKER_HEARTBEAT_URL: string | undefined
